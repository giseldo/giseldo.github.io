Title: Modelo LLM Nemotron 70B: Um primeiro contato
Date: 2024-10-22
Category: Blog
...
Em julho de 2024, a Meta lançou um modelo de linguagem (LLM) open-source, o _Llama-3.1-70B_. Um pouco depois, em setembro a empresa NVIDIA lançou um derivado deste, o *Llama 3.1-Nemotron-51B-Instruct*. E em outubro lançou finalmente um modelo de 70b customizado, o _Llama 3.1 nemotron-70b-instruct_.

O _nemotron-70b_ performou melhor, em alguns testes comparativos, do que o GPT-4o. Nos testes, ele liderou em desempenho geral e também se destacou nas categorias chat (_chat score_) e raciocínio (_reasoning score_). Veja na **Tabela 1**.
...
<center>**Figura 1** - Demonstração do Nemotron 70B no site da NVidea</center></br>
<img src="{static}/images/democracia_nvidia.png" alt="Exemplo do Nemotron" style="width:100%;"/>
<center>Fonte: O Autor (2024)</center>

<center>**Figura 2** - Demonstração no Groq Cloud do modelo 70B tool use preview</center></br>
<img src="{static}/images/democracia_groq.png" alt="Exemplo do Groq Cloud" style="width:100%;"/>
<center>Fonte: O Autor (2024)</center>
